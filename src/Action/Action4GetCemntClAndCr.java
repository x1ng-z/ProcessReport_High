...
import static org.apache.cxf.ws.eventing.backend.notification.NotificatorService.CORE_POOL_SIZE;
 ...
 * @date 2020/9/3 8:33
 */
public class Action4GetCemntClAndCr implements Callable<JSONArray> {
    ...
    public Action4GetCemntClAndCr(HttpServletRequest httpServletRequest, ServletContext servletContext) {
       ...
       long starttime=System.currentTimeMillis();
        ...
        for(Firm firm:processMgr.getFirmmmaping().values()){
            pool.execute(new Runnable() {
                @Override
                public void run() {
                    JSONObject firmresult=OracleMESdb_Access_Data.getCemntSystemClAndCr(firm,startdate,enddate);
        ...
        System.out.println("Action4GetFiredClAndCr total cost time="+(System.currentTimeMillis()-starttime));;
