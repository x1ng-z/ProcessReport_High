 ...
 * @date 2020/9/3 8:33
 */
public class Action4GetFiredClAndCr implements Callable<JSONArray> {
    ...
    public Action4GetFiredClAndCr(HttpServletRequest httpServletRequest, ServletContext servletContext) {
    ...
    public JSONArray call() throws Exception {
        ...
        for (Firm firm : processMgr.getFirmmmaping().values()) {
            ...
            pool.execute(new Runnable() {
                @Override
                public void run() {
                    JSONObject firmresult = OracleMESdb_Access_Data.getFiredSystemClAndCr(firm, startdate, enddate);
