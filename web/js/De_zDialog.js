...
var IMAGESPATH = 'img/dialog/'; //图片路径配置，如在有iframe情况下使用，此路径为最顶层窗口页面的相对路径
...
/*onmouseout="this.style.backgroundImage=\'url({IMAGESPATH}dialog_closebtn.gif)\'" onmouseover="this.style.backgroundImage=\'url({IMAGESPATH}dialog_closebtn_over.gif)\'" */
Dialog.prototype.create = function () {
  ...
  <table id="_DialogTable_{thisID}" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" style="font-size:12px; line-height:1.4;border-collapse: collapse;">\
    <tr id="_Draghandle_{thisID}" onselectstart="return false;" style="-moz-user-select: -moz-none; ' + (this.Drag ? "cursor: move;" : "") + '">\
      <td width="13" height="33" style="background-color: #000c3b; !important;background:#000c3b;"><div style="width: 13px;"></div></td>\
      <td height="33" style="background-color: #000c3b; !important;background: #000c3b;"><div style="padding: 9px 0 0 4px; float: left; font-weight: bold; color:#fff;">\
      <img align="absmiddle" src="{IMAGESPATH}icon_dialog.gif"/><span id="_Title_{thisID}">' + this.Title + '</span></div>\
        <div id="_ButtonClose_{thisID}" onclick="Dialog.getInstance(\'{thisID}\').cancelButton.onclick.apply(Dialog.getInstance(\'{thisID}\').cancelButton,[]);"  \
        style="margin: 4px 0 0;*margin-top: 5px; position: relative;top:auto; cursor: pointer; float: right; height: 17px; width: 28px; background-image:url({IMAGESPATH}dialog_closebtn.gif);'
        + (ielt7 ? "margin-top: 3px;" : "") + (this.ShowCloseButton ? "" : "display:none;") + '"></div></td>\
      <td width="13" height="33" style="background-color: #000c3b; !important;background: #000c3b;"><div style="width: 13px;"><a id="_forTab_{thisID}" href="#;"></a></div></td>\
    </tr>\
    <tr valign="top">\
      <td width="13" style="background-color: #000c3b; !important;background:#000c3b;"></td>\
      <td align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff">\
          <tr id="_MessageRow_{thisID}" style="' + (this.ShowMessageRow ? "" : "display:none") + '">\
            <td valign="top" height="50"><table width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#000c3b;" id="_MessageTable_{thisID}">\
                <tr>\
          ...
          <tr>\
            <td valign="top" align="center"><div id="_Container_{thisID}" style="position: relative; width: ' + this.Width + 'px; height: ' + this.Height + 'px;">\
                <div style="position: absolute; height: 100%; width: 100%; display: none; background-color:#000c3b; opacity: 0.5;" id="_Covering_{thisID}">&nbsp;</div>\
	' + (function (obj) {
    ...
    <tr>\
      <td width="13" height="13" style="background-color: #000c3b;!important;background: #000c3b;"></td>\
      <td style="background-color: #000c3b; !important;background:#000c3b;"></td>\
      <td width="13" height="13" style="background-color: #000c3b; !important;background:#000c3b;"><a onfocus=\'$id("_forTab_{thisID}").focus();\' href="#;"></a></td>\
    </tr>\
  </table>\
</div>\
';
...
Dialog.getBgdiv = function () {
    ...
    if (!bgdiv) {
		...
		var bgIframeMask = '<div id="_DialogBGMask" style="position:absolute;background-color:#000c3b;opacity:0.4;filter:alpha(opacity=40);width:100%;height:100%;"></div>';
        ...
        if (ielt7) {
            ...
            bgIframeDoc.open();
            bgIframeDoc.write("<body style='background-color:#000c3b' oncontextmenu='return false;'></body>");
            bgIframeDoc.close();
			bgIframeDoc=null;
        }
    }
...
for(var i=0;i<scripts.length;i++){
	...
	if(/.*zDialog\.js$/g.test(scripts[i].getAttribute("src"))){
		...
		document.write('<script type="text/javascript" src=' + jsPath + '"De_zDrag.js"><\/script>') ;
		break;
	}
}
