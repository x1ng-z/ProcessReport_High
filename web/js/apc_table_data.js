...
let data_t1;
function apc_totaldata_flush(){
    clearInterval(data_t1);
    apc_pyro_dataTotal();
    data_t1 =setInterval(apc_totaldata_flush,30*1000);
}


function apc_pyro_dataTotal() {
    let xmlhttp;
...
//兰溪一线
            ...
            let zjlx1_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysZJLX_K1), "-", apc_loop_value("分解炉出口温度1",sysZJLX_K1),
                            "-",apc_looprate_fired("ZJLX","L1_FTemp_AT")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:[apc_loop_state("篦冷机APC一段篦速",sysZJLX_K1),"-", apc_loop_value("篦冷机层压反馈",sysZJLX_K1),
                            apc_loop_value("篦冷机篦速1输出",sysZJLX_K1),apc_looprate_fired("ZJLX","L1_BLJ1_AT")]},
...
//兰溪二线
            ...
            let zjlx2_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:["手动", "-", apc_loop_value("分解炉出口温度1",sysZJLX_K2), "-","0%"]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:["手动","-", apc_loop_value("篦冷机层压反馈",sysZJLX_K2), apc_loop_value("篦冷机篦速1输出",sysZJLX_K2),"0%"]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//兰溪三线
            ...
            let zjlx3_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:["手动", "-", apc_loop_value("分解炉出口温度1",sysZJLX_K3), "-","0%"]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:["手动","-", apc_loop_value("篦冷机层压反馈",sysZJLX_K3), apc_loop_value("篦冷机篦速1输出",sysZJLX_K3),"0%"]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//建德一线
            ...
            let hzjd1_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:["手动", "-", apc_loop_value("分解炉出口温度1",sysHZJD_K1), "-","0%"]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:["手动","-", apc_loop_value("篦冷机层压反馈",sysHZJD_K1), apc_loop_value("篦冷机篦速1输出",sysHZJD_K1),"0%"]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//建德二线
            ...
            let hzjd2_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:["手动", "-", apc_loop_value("分解炉出口温度1",sysHZJD_K2), "-","0%"]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:["手动","-", apc_loop_value("篦冷机层压反馈",sysHZJD_K2), apc_loop_value("篦冷机篦速1输出",sysHZJD_K2),"0%"]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//桐庐红狮
            ...
            let hztl1_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:["手动", "-", apc_loop_value("分解炉出口温度1",sysHZTL_K1), "-","0%"]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:["手动","-", apc_loop_value("篦冷机层压反馈",sysHZTL_K1), apc_loop_value("篦冷机篦速1输出",sysHZTL_K1),"0%"]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//高安一线
            ...
            let jxga1_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysJXGA_K1), apc_loop_value("窑尾喂煤温度设定",sysJXGA_K1), apc_loop_value("分解炉出口温度1",sysJXGA_K1),
                            "-",apc_looprate_fired("JXGA","L1Ftemp_AUTO")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:[apc_loop_state("篦冷机APC一段篦速",sysJXGA_K1),apc_loop_value("篦冷机层压设定",sysJXGA_K1), apc_loop_value("篦冷机层压反馈",sysJXGA_K1),
                            apc_loop_value("篦冷机篦速1输出",sysJXGA_K1),apc_looprate_fired("JXGA","L1Gcool_AUTO")]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//高安二线
            ...
            let jxga2_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysJXGA_K2), apc_loop_value("窑尾喂煤温度设定",sysJXGA_K2), apc_loop_value("分解炉出口温度1",sysJXGA_K2),
                            "-",apc_looprate_fired("JXGA","L2Ftemp_AUTO")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:[apc_loop_state("篦冷机APC一段篦速",sysJXGA_K2),apc_loop_value("篦冷机层压设定",sysJXGA_K2), apc_loop_value("篦冷机层压反馈",sysJXGA_K2),
                            apc_loop_value("篦冷机篦速1输出",sysJXGA_K2),apc_looprate_fired("JXGA","L2Gcool_AUTO")]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//会昌红狮
            ...
            let jxhc_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysJXHC_K1), apc_loop_value("窑尾喂煤温度设定",sysJXHC_K1), apc_loop_value("分解炉出口温度1",sysJXHC_K1),
                            "-",apc_looprate_fired("JXHC","Ftemp_auto")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:[apc_loop_state("篦冷机APC一段篦速",sysJXHC_K1),apc_loop_value("篦冷机层压设定",sysJXHC_K1), apc_loop_value("篦冷机层压反馈",sysJXGA_K2),
                            apc_loop_value("篦冷机篦速1输出",sysJXHC_K1),apc_looprate_fired("JXHC","Gcool_auto")]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//江西鹰鹏
            ...
            let jxyp_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysJXYP_K1), apc_loop_value("窑尾喂煤温度设定",sysJXYP_K1), apc_loop_value("分解炉出口温度1",sysJXYP_K1),
                            "-",apc_looprate_fired("JXYP","Ftemp_Auto")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
...
//衡阳红狮
            ...
            let jxhy_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysJXHY_K1), apc_loop_value("窑尾喂煤温度设定",sysJXHY_K1), apc_loop_value("分解炉出口温度1",sysJXHY_K1),
                            "-",apc_looprate_fired("JXHC","Ftemp_auto")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:[apc_loop_state("篦冷机APC一段篦速",sysJXHY_K1),"-", apc_loop_value("篦冷机层压反馈",sysJXHY_K1),
                            apc_loop_value("篦冷机篦速1输出",sysJXHY_K1),apc_looprate_fired("JXHY","Gcool_auto")]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//宁远莲花
            ...
            let jxny_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysJXNY_K1), apc_loop_value("窑尾喂煤温度设定",sysJXYP_K1), apc_loop_value("分解炉出口温度1",sysJXNY_K1),
                            "-",apc_looprate_fired("JXNY","Ftemp_Auto")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
...
//永州红狮
            ...
            let jxyz_table = [
                {system:"生料磨系统",
                    loop:[{loopname:"1#磨产量",
                        loopdata:[
                            raw_data[13].loop[0].loopdata[0],raw_data[13].loop[0].loopdata[1],raw_data[13].loop[0].loopdata[2],
                            raw_data[13].loop[0].loopdata[3],raw_data[13].loop[0].loopdata[4]
                        ]},
                        {loopname:"2#磨产量",
                            loopdata:[
                                raw_data[13].loop[1].loopdata[0],raw_data[13].loop[1].loopdata[1],raw_data[13].loop[1].loopdata[2]
                                ,raw_data[13].loop[1].loopdata[3],raw_data[13].loop[0].loopdata[4]]}
                    ]},
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",
                        loopdata:[
...
//漳平一线
            ...
            let fjzp1_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysFJZP_K1), apc_loop_value("窑尾喂煤温度设定",sysFJZP_K1), apc_loop_value("窑尾喂煤温度反馈",sysFJZP_K1),
                            apc_loop_value("分解炉出口温度1",sysFJZP_K1),apc_looprate_fired("FJZP","APC1_FJLAM")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:[apc_loop_state("篦冷机APC一段篦速",sysFJZP_K1),apc_loop_value("篦冷机层压设定",sysFJZP_K1), apc_loop_value("篦冷机层压反馈",sysFJZP_K1),
                            apc_loop_value("篦冷机篦速1输出",sysFJZP_K1),apc_looprate_fired("FJZP","APC1_BLJAM")]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//漳平二线
            ...
            let fjzp2_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysFJZP_K2), apc_loop_value("窑尾喂煤温度设定",sysFJZP_K2), apc_loop_value("分解炉出口温度1",sysFJZP_K2),
                            "-",apc_looprate_fired("FJZP","APC_FJLAM2")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:[apc_loop_state("篦冷机APC一段篦速",sysFJZP_K2),apc_loop_value("篦冷机层压设定",sysFJZP_K2), apc_loop_value("篦冷机层压反馈",sysFJZP_K2),
                            apc_loop_value("篦冷机篦速1输出",sysFJZP_K2),apc_looprate_fired("FJZP","APC_BLJAM2")]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//漳平三期
            ...
            let fjzp3_table = [
                {system:"生料磨系统",
                    loop:[{loopname:"1#磨产量",
                        loopdata:[
                            raw_data[16].loop[0].loopdata[0],raw_data[16].loop[0].loopdata[1],
                            raw_data[16].loop[0].loopdata[2],raw_data[16].loop[0].loopdata[3],raw_data[16].loop[0].loopdata[4]]},
                        {loopname:"2#磨产量",
                            loopdata:[
                                raw_data[16].loop[1].loopdata[0],raw_data[16].loop[1].loopdata[1],
                                raw_data[16].loop[1].loopdata[2],raw_data[16].loop[1].loopdata[3],raw_data[16].loop[1].loopdata[4]]}
                    ]},
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",
                        loopdata:[
...
//大田红狮
            ...
            let fjdt_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:["手动", "-", apc_loop_value("分解炉出口温度1",sysFJDT_K1), "-","0%"]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:["手动","-", apc_loop_value("篦冷机层压反馈",sysFJDT_K1), apc_loop_value("篦冷机篦速1输出",sysFJDT_K1),"0%"]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//邻水一线
            ...
            let scls1_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:["手动", "-", apc_loop_value("分解炉出口温度1",sysSCLS_K1), "-","0%"]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:["手动","-", apc_loop_value("篦冷机层压反馈",sysSCLS_K1), apc_loop_value("篦冷机篦速1输出",sysSCLS_K1),"0%"]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//邻水二线
            ...
            let scls2_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:["手动", "-", apc_loop_value("分解炉出口温度1",sysSCLS_K2), "-","0%"]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:["手动","-", apc_loop_value("篦冷机层压反馈",sysSCLS_K2), apc_loop_value("篦冷机篦速1输出",sysSCLS_K2),"0%"]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//江油红狮
            ...
            let scjy_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysSCJY_K1), apc_loop_value("窑尾喂煤温度设定",sysSCJY_K1), apc_loop_value("分解炉出口温度1",sysSCJY_K1),
                            "-",apc_looprate_fired("SCJY","APC_FJLAM2")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:[apc_loop_state("篦冷机APC一段篦速",sysSCJY_K1),apc_loop_value("篦冷机层压设定",sysSCJY_K1), apc_loop_value("篦冷机层压反馈",sysSCJY_K1),
                            apc_loop_value("篦冷机篦速1输出",sysSCJY_K1),apc_looprate_fired("SCJY","APC_BLJAM2")]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//长宁红狮
            ...
            let sccn_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysSCCN_K1), apc_loop_value("窑尾喂煤温度设定",sysSCCN_K1), apc_loop_value("分解炉出口温度1",sysSCCN_K1),
                            "-",apc_looprate_fired("SCCN","Ftemp_AUTO")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:[apc_loop_state("篦冷机APC一段篦速",sysSCCN_K1),apc_loop_value("篦冷机层压设定",sysSCCN_K1), apc_loop_value("篦冷机层压反馈",sysSCCN_K1),
                            apc_loop_value("篦冷机篦速1输出",sysSCCN_K1),apc_looprate_fired("SCCN","Gcool_AUTO")]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//宜良一线
            ...
            let ynyl1_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysYNYL_K1), apc_loop_value("窑尾喂煤温度设定",sysYNYL_K1), apc_loop_value("分解炉出口温度1",sysYNYL_K1),
                            "-",apc_looprate_fired("YNYL","FJL_AUTO")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:[apc_loop_state("篦冷机APC一段篦速",sysYNYL_K1),apc_loop_value("篦冷机层压设定",sysYNYL_K1), apc_loop_value("篦冷机层压反馈",sysYNYL_K1),
                            apc_loop_value("篦冷机篦速1输出",sysYNYL_K1),apc_looprate_fired("YNYL","BLJ1_AUTO")]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//宜良二线
            ...
            let ynyl2_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysYNYL_K2), apc_loop_value("窑尾喂煤温度设定",sysYNYL_K2), apc_loop_value("分解炉出口温度1",sysYNYL_K2),
                            "-",apc_looprate_fired("YNYL","L2_FJL_AUTO")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:[apc_loop_state("篦冷机APC一段篦速",sysYNYL_K2),apc_loop_value("篦冷机层压设定",sysYNYL_K2), apc_loop_value("篦冷机层压反馈",sysYNYL_K2),
                            apc_loop_value("篦冷机篦速1输出",sysYNYL_K2),apc_looprate_fired("YNYL","L2_BLJ1_AUTO")]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//龙里一线
            ...
            let ynll1_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysYNLL_K1), apc_loop_value("窑尾喂煤温度设定",sysYNLL_K1), apc_loop_value("分解炉出口温度1",sysYNLL_K1),
                            "-",apc_looprate_fired("YNLL","F1temp_auto")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:["手动","-", apc_loop_value("篦冷机层压反馈",sysYNLL_K1), apc_loop_value("篦冷机篦速1输出",sysYNLL_K1),"0%"]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//龙里二线
            ...
            let ynll2_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysYNLL_K2), apc_loop_value("窑尾喂煤温度设定",sysYNLL_K2), apc_loop_value("分解炉出口温度1",sysYNLL_K2),
                            "-",apc_looprate_fired("YNLL","APCC5_AM")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:[apc_loop_state("篦冷机APC一段篦速",sysYNLL_K1),apc_loop_value("篦冷机层压设定",sysYNLL_K2), apc_loop_value("篦冷机层压反馈",sysYNLL_K2),
                            apc_loop_value("篦冷机篦速1输出",sysYNLL_K2),apc_looprate_fired("YNLL","APCBLJ_AM")]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//茂鑫红狮
            ...
            let ynmx_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysYNMX_K1), apc_loop_value("窑尾喂煤温度设定",sysYNMX_K1), apc_loop_value("分解炉出口温度1",sysYNMX_K1),
                            "-",apc_looprate_fired("YNMX","Ftemp_auto")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:["手动","-", apc_loop_value("篦冷机层压反馈",sysYNMX_K1), apc_loop_value("篦冷机篦速1输出",sysYNMX_K1),"0%"]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//南宁红狮
            ...
            let ynnn_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysYNNN_K1), apc_loop_value("窑尾喂煤温度设定",sysYNNN_K1), apc_loop_value("分解炉出口温度1",sysYNNN_K1),
                            "-",apc_looprate_fired("YNNN","AM750102")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:[apc_loop_state("篦冷机APC一段篦速",sysYNNN_K1),"-", apc_loop_value("篦冷机层压反馈",sysYNNN_K1),
                            apc_loop_value("篦冷机篦速1输出",sysYNNN_K1),apc_looprate_fired("YNNN","ZD570202")]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//崇左红狮
            ...
            let yncz_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysYNCZ_K1), apc_loop_value("窑尾喂煤温度设定",sysYNCZ_K1), apc_loop_value("分解炉出口温度1",sysYNCZ_K1),
                            "-",apc_looprate_fired("YNCZ","M7501auto")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:[apc_loop_state("篦冷机APC一段篦速",sysYNCZ_K1),apc_loop_value("篦冷机层压设定",sysYNCZ_K1), apc_loop_value("篦冷机层压反馈",sysYNCZ_K1),
                            apc_loop_value("篦冷机篦速1输出",sysYNCZ_K1),apc_looprate_fired("YNCZ","BLJYD_auto")]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//广西恒庆
            ...
            let ynhq_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysYNHQ_K1), apc_loop_value("窑尾喂煤温度设定",sysYNHQ_K1), apc_loop_value("分解炉出口温度1",sysYNHQ_K1),
                            "-",apc_looprate_fired("YNHQ","APC_WMC_AUTO1")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
...
//兰州红狮
            ...
            let jtlz_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysJTLZ_K1), apc_loop_value("窑尾喂煤温度设定",sysJTLZ_K1), apc_loop_value("分解炉出口温度1",sysJTLZ_K1),
                            "-",apc_looprate_fired("JTLZ","Ftemp_auto")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:["手动","-", apc_loop_value("篦冷机层压反馈",sysJTLZ_K1), apc_loop_value("篦冷机篦速1输出",sysJTLZ_K1),"0%"]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//库车红狮
            ...
            let jtkc_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysJTKC_K1), apc_loop_value("窑尾喂煤温度设定",sysJTKC_K1), apc_loop_value("分解炉出口温度1",sysJTKC_K1),
                            "-",apc_looprate_fired("JTKC","Ftemp_Auto")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
                    loop:[{loopname:"一段篦速",loopdata:[apc_loop_state("篦冷机APC一段篦速",sysJTKC_K1),apc_loop_value("篦冷机层压设定",sysJTKC_K1), apc_loop_value("篦冷机层压反馈",sysJTKC_K1),
                            apc_loop_value("篦冷机篦速1输出",sysJTKC_K1),apc_looprate_fired("JTKC","Gcool_Auto")]},
                        {loopname:"二段篦速",loopdata:[" "," "," "," "]},
                        {loopname:"头排",loopdata:[" "," "," "," "]}
                    ]},
                {system:"煤磨系统",
...
//老挝万象
            ...
            let hwwx_table = [
                ...
                {system:"回转窑系统",
                    loop:[{loopname:"尾煤",loopdata:[apc_loop_state("窑尾喂煤APC尾煤",sysHWWX_K1), apc_loop_value("窑尾喂煤温度设定",sysHWWX_K1), apc_loop_value("分解炉出口温度1",sysHWWX_K1),
                            "-",apc_looprate_fired("HWWX","Ftemp_auto")]},
                        {loopname:"头煤",loopdata:[" "," "," "," "]},
                        {loopname:"窑速",loopdata:[" "," "," "," "]}
                    ]},
                {system:"篦冷机系统",
